    ...
    e.fn.prettyPhoto = function (s) {
        function g() {
            ...
            $pp_pic_holder.animate({top: projectedTop, left: v / 2 - a["containerWidth"] / 2 < 0 ? 0 : v / 2 - a["containerWidth"] / 2, width: a["containerWidth"]}, settings.animation_speed, function () {
                ...
                $pp_pic_holder.find(".pp_hoverContainer").height(a["height"]-50);
                $pp_pic_holder.find(".pp_fade").fadeIn(settings.animation_speed);
                if (isSet && S(pp_images[set_position]) == "image" ||isSet && S(pp_images[set_position]) == "inline") {
            ...
            $pp_pic_holder.fadeIn(function () {
                ...
                switch (S(pp_images[set_position])) {
                    ...
                    case"inline":
                        ...
                        var imgw = myClone.find(".image-shadow").width();
                        myClone.css({width:imgw});
